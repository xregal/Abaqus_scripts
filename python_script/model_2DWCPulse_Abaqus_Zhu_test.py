...
jobFileName='Classic_orthotropique_betaD0'
...
#----------------------------------------------------------------------------
# Material Definition
specMat=mymodel.Material(name='Orthotropic')
specMat.Density(table=((specRho, ), ))
specMat.Elastic(type=ORTHOTROPIC, table=((Q11, Q12, Q22, Q13, Q23, Q33, Q66, 0.0, 0.0), ))
...
section_specimen=mymodel.HomogeneousSolidSection(name='Section-Specimen', 
	material='Orthotropic', thickness=specThick)
