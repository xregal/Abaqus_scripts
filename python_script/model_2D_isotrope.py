...
jobFileName='PVC_model_elastic_lin'
SubroutinesPath = 'C:\\Users\\radg0\\Documents\\abaqus_data\\VUAMP\\sine_ramp.for'
...
Sonotrode=mdb.Job(name=jobFileName, model=jobFileName, description='', type=ANALYSIS, 
	...
	contactPrint=OFF, historyPrint=OFF, userSubroutine=SubroutinesPath, scratch='', 
