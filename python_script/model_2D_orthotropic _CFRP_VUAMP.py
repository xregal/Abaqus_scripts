...
extension='Plate_orthotropic/'
jobFileName='standard_elas_60_VUAMP_BIS'
...
specNu12 = 0.3
Cv = 1450 
specWaveSpeed = math.sqrt(specE11/specRho)
beta = 0 
delta = 0.1
...
myviewport=session.Viewport(name='ExpDynSonotrode2D',origin=(0.0, 0.0))
