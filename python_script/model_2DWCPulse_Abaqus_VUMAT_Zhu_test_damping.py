...
extension='Zhu_retests/'
jobFileName='Vumat_orthotropique_betaD0'
...
beta22 = 6.0e8
beta66 = 3.5e8
specWaveSpeed = math.sqrt(Q11/specRho)
...
#----------------------------------------------------------------------------
# Material Definition
specMat=mymodel.Material(name='User_mat_defined')
specMat.Density(table=((specRho, ), ))
specMat.Depvar(n=4)
specMat.UserMaterial(mechanicalConstants=(Q11, Q12, Q22, Q13, Q23, Q33, Q66, betaDamping))
...
section_specimen=mymodel.HomogeneousSolidSection(name='Section-Specimen', 
	material='User_mat_defined', thickness=specThick)
...
Impact=mdb.Job(name=jobFileName, model=jobFileName, description='', type=ANALYSIS, 
    ...
    userSubroutine='C:\\Users\\radg0\\Documents\\abaqus_data\\VUMAT\\strain_rate_dependence_vumat_haibin_damping.for',  
...
if outputGlobalCoords:	
	...
	session.viewports['ExpDynPulse2D'].odbDisplay.basicOptions.setValues(
		transformationType=USER_SPECIFIED, datumCsys=dtm)

nsteps=len(odb.steps['Impact'].frames)-1
