...
jobFileName='standard_plas_05mm_15MPa_betadamp_10em7'
...
specMat.Plastic(hardening=JOHNSON_COOK,table=((JCA, JCB, JCn, JCm, 2000.0, 1500.0), ))
#specMat.plastic.RateDependent(type=JOHNSON_COOK, table=((JCC, 1.0), ))
...
freq1 = 2.0*3.14159*freq0 
	
mymodel.PeriodicAmplitude(name='Sinwave', timeSpan=STEP, 
    frequency=freq1, start=0.0, a_0=0.0, data=((0.0, 1.0), ))	
...
elementType=mesh.ElemType(elemCode=CPS6M, elemLibrary=EXPLICIT,secondOrderAccuracy=OFF, 
